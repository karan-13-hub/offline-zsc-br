...
if __name__ == "__main__":
    ...
    print("Buffer size: ", replay_buffer.__len__())
    print("Success, Done")
    print("=======================")
    ...
    for epoch in range(args.num_epoch):
        ...
        visits = replay_buffer.get_visits()
        #Mean of visits
        mean_visits = np.mean(visits)

        #median of visits
        median_visits = np.median(visits)

        #max of visits
        max_visits = np.max(visits)
        
        print("Mean of visits: ", mean_visits)
        print("Median of visits: ", median_visits)
        print("Max of visits: ", max_visits)
        print("==========")
