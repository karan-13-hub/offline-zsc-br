...
python selfplay_mi_sim_br.py \
       --save_dir exps/br_medium_data_seed_1337_31415_271828_380843_7777777_1e9+7/vdn_cp_bc_0.4 \
       ...
       --train_device cuda:7 \
       --dataset_path /data/kmirakho/hanabi_2p/data/vdn_offline_data_seed_1337/data_80\
       --data_sample 0.75\
       --wgt_thr 0.25\
       --div True\
       # --cp True\
