...
python selfplay_mi_sim_br_hansel.py \
       ...
       --train_device cuda:3 \
       --dataset_path /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-1337/data_2560 /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-31415/data_2560 /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-271828/data_2560 /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-380843/data_2560 /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-7777777/data_2560 /data/kmirakho/hanabi_3p/data/np3_vdn_offline_data_seed-1e9+7/data_2560\
       --data_sample 0.75\
       --wgt_thr 0.25\
